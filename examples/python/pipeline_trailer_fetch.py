...
from popcorn.pipelines.trailer_fetch.core import downloadTrailers
from popcorn.datasets.popcorn.helper_metadata import fetchRandomMovies
...
def main():
    ...
    print(f"\n- Picking 3 random movies from the dataset ...")
    pickedMovies = fetchRandomMovies(jsonData, count=3)
    if not pickedMovies:
