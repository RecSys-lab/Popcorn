...
from popcorn.datasets.movifex.helper_visualfeats_agg import generatedAggFeatureAddresses, loadAggregatedFeaturesIntoDataFrame
...
def fuseTextualWithSceneSense(cfgRecSys: dict, cfgDatasets: dict):
    ...
    aggFeatureAddresses = generatedAggFeatureAddresses(cfgDatasets['multimodal']['movifex'])
